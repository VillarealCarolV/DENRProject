...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="fw-bold text-dark"><i class="fas fa-edit me-2 text-primary"></i> Edit Land Record</h3>
    ...
    <div class="card shadow-sm border-0">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0"><i class="fas fa-pencil-alt me-2"></i> Update Land Record</h5>
        </div>
        <div class="card-body p-4">
            ...
            <form action="{{ route('land-records.update', $landRecord->id) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input 
                                ...
                                value="{{ old('survey_no', $landRecord->survey_no) }}"
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input 
                                ...
                                value="{{ old('total_area', $landRecord->total_area) }}"
                ...
                <div class="mb-3">
                    ...
                    <input 
                        ...
                        value="{{ old('location', $landRecord->location) }}"
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-primary fw-bold shadow-sm">
                        <i class="fas fa-save me-2"></i> Update Land Record
                    </button>
                    <a href="{{ route('land-records.show', $landRecord->id) }}" class="btn btn-secondary fw-bold">
