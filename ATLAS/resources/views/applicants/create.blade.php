...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="fw-bold text-dark"><i class="fas fa-user-plus me-2 text-primary"></i> Create Applicant</h3>
    ...
    <div class="card shadow-sm border-0" style="max-width: 600px;">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0"><i class="fas fa-plus me-2"></i> Add New Applicant</h5>
        </div>
        <div class="card-body p-4">
            ...
            <form action="{{ route('applicants.store') }}" method="POST">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('applicants.index') }}" class="btn btn-secondary fw-bold">
